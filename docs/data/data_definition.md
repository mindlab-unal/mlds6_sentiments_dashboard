...
| ---:| ---: | ---: | ---: | -----: |
| Paper reviews dataset | [Link to reviews dataset](https://archive.ics.uci.edu/ml/machine-learning-databases/00410/) | `${SENTIMENTS_DATASETS}`| [download_dataset.sh](scripts/data_acquisition/download_dataset.sh)| - |
